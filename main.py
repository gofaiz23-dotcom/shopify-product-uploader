...
# Import our modules
from src.core import ExcelReader, AIDescriptionGenerator, BatchProcessor, ProductProcessor, PricingCalculator
...
class ShopifyUploadSystem:
    ...
    def initialize_components(self):
        ...
        try:
            ...
            self.logger.info("Initializing AI description generator...")
            self.ai_generator = AIDescriptionGenerator(api_key=ai_config['api_key'])
